...
This analysis of the Superstore dataset revealed several important business insights across product categories, regions, discounts, and time trends:
...
📥 Clone this repository or download the project files locally
🐍 Ensure Python is installed, along with the required libraries:
pandas
matplotlib
seaborn
📓 Open notebooks/Superstore_Sales_Analysis.ipynb in Jupyter Notebook
▶️ Run all cells sequentially from top to bottom
💾 The cleaned dataset will be automatically exported to:
...
🔗 LinkedIn: www.linkedin.com/in/enock-mntungwa-803534227
